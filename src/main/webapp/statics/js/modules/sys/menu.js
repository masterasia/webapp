...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '类型', field: 'menuType', align: 'center', valign: 'middle', sortable: true, width: '100px', formatter: function(item, index){
            if(item.menuType === 0){
        ...
        {title: '菜单路径', field: 'menuPath', align: 'center', valign: 'middle', sortable: true, width: '160px'},
